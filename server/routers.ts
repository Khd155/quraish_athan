  ...
  meetings: router({
    create: protectedProcedure
      .input(z.object({
        ...
        department: z.enum(["technology", "catering", "transport", "cultural", "media", "supervisors", "registration", "mina_preparation", "arafat_preparation", "muzdalifah_preparation", "quality", "other"]).optional(),
